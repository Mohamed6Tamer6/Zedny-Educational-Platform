...
from app.api.v1.endpoints import health, auth, quizzes, generate, admin, courses, uploads, ai
...
api_router.include_router(courses.router, prefix="/courses", tags=["LMS Courses"])
